      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col lg:flex-row justify-between items-center">
          <div id="contact" className="mb-4 lg:mb-0">
            <h3 className="text-xl font-bold">Macro Cookies</h3>
            ...
            <div className="mt-4">
              ...
              <p className="text-gray-300 mb-1">Email: info@macrocookies.com</p>
        ...
        <div className="text-center text-gray-300 mt-4">
          &copy; {new Date().getFullYear()} Macro Cookies. All rights reserved.
        </div>
      </div>
    </footer>
  );
